...
export const Header = () => {
  ...
  return (
    <header className="relative overflow-hidden py-2">
      <video autoPlay muted loop playsInline className="absolute left-0 top-0 w-full h-auto" poster="/poster-image.jpg">
        <source src="https://d33wubrfki0l68.cloudfront.net/2500bc5ef1b96927e0220eeb2bef0b22b87bcda1/3e0d3/static/moshed-aa65f0933af9abe9afb5e5663c9b3f68.mp4" type="video/mp4" />
      </video>

      <div className="relative flex items-center justify-between bg-white dark:bg-black p-2">
        <svg aria-label="Vega logo" width="111" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M10.371 20.794 17.183.02h3.42l-8.436 23.965H8.471L0 .02h3.48l6.891 20.774ZM34.994 13.019v8.249h13.382v2.716H31.782V.019h16.3v2.715H34.994v7.577h11.658v2.708H34.994ZM61.25 2.92h2.88v18.195h-2.88V2.92ZM75.653 0v2.92H64.129V0h11.525ZM64.129 24v-2.885h11.525V24H64.129Zm14.405-2.885h-2.88v-5.77h-5.762v-2.89h8.642v8.66Zm0-18.195v2.884h-2.88V2.92h2.88ZM110.71 23.984h-3.354l-1.763-4.826h-12.03L91.8 23.984h-3.279L97.807.019h3.626l9.277 23.965ZM99.528 2.904l-4.949 13.544h10.002L99.597 2.903h-.07Z"></path></svg>
          ...
          { darkMode ? (
            ...
            <svg width="45" height="45">
              <g>
                ...
                <path d="M15.01 22.5H10M35 22.5h-5.01M22.5 29.99V35M22.5 10v5.01M17.21 27.79l-3.55 3.55M31.34 13.66l-3.55 3.55M27.79 27.79l3.55 3.55M13.66 13.66l3.55 3.55" stroke="currentColor" strokeWidth="1.3" strokeMiterlimit="10"></path>
              </g>
            </svg>
          ) }
        </button>
